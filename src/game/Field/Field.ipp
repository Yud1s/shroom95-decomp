...
__SUB_CLASS_THIS(0013CBD0, __thiscall, 24972,  CField, void, NakedParam<ZXString<char>>, NakedParam<ZXString<char>>) {
	_ASM_PLACEHOLDER(0013CBD0, 24972)
}
