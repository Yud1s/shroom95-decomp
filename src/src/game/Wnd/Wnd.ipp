...
__SUB_CLASS_THIS(000F07F0, __thiscall, 5013,  CWnd, void, CCtrlWnd*, __POSITION*) {
	_ASM_PLACEHOLDER(000F07F0, 5013)
}
// CWnd::CWnd
__SUB_CLASS_THIS0(005AED30, __thiscall, 4952,  CWnd, void) {
	_ASM_PLACEHOLDER(005AED30, 4952)
}
